function [startTime, sType] = SingleBar(win, angle, size, speed, amplitude, internalRotation, daq)
...
rect=SetRect(900-(size/2),0,900+(size/2),1280);
...
while endTime < duration([0,0,1.5])
    ...
    Screen('DrawTexture', win, gratingtex, rect, [], angle, [], [], [], [], rotateMode, [phase, speed, amplitude, 0]);

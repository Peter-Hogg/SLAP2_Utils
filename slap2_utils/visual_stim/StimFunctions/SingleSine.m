function [startTime, sType] = SingleSine(win, angle, cyclespersecond, freq, gratingsize, internalRotation, daq)
...
rect=SetRect(900-(gratingsize/2),0,900+(gratingsize/2),1280);
...
while endTime < duration([0,0,1.5]);
    ...
    Screen('DrawTexture', win, gratingtex, rect, [], angle, [], [], [], [], rotateMode, [phase, freq, amplitude, 0]);

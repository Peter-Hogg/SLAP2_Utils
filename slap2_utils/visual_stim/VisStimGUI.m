...
primeGratingProbing  = uicontrol(gcf,'Style', 'push', ...
                           'String', 'Prime Grating', ...
                           'Position', [20 290 180 30], ...
                           'CallBack', @primeGratingStimuli);
...
function primeGratingStimuli(source,event)
    gratingProbing(myWin, DAQ6001)
end

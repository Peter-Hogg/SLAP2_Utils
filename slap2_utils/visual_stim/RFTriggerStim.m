...
listenForRisingEdge(daqDevice, channel, threshold, callback, myWin, winRect);





function listenForRisingEdge(daqDevice, channel, threshold, callback, window, rect)
    persistent DAQses,
    ...
    function myCallbackFunction()
        ...
        %[t, sType, angle, speed] = 
        gratingRFbattery(window, rect, DAQ6001)
